...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "user1@email.com", "location1", 1, LocalDateTime.now());
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "user2@email.com", "location2", 2, LocalDateTime.now());
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "user3@email.com", "location3", 3, LocalDateTime.now());
